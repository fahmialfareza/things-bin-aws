...
function completeGet(result) {
    if (result[0].mean == "nan") {
        $('#nan').fadeIn('slow')
    } else {
        $('#nan').fadeOut('slow')
    }
    ...
    result.forEach(element => {
        myBarChart.data.labels.push(element.sensor)
        myBarChart.data.datasets[0].data.push(element.mean)
    });
